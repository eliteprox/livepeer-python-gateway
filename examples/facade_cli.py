...
def facade_start_lv2v_kwargs(
    ...
    *,
    ...
    if not args.billing_url or not args.issuer_url:
        return {}
    signer = (
        resolve_signer_url(args, signer_attr=signer_attr)
        or signer_base_from_issuer(args.issuer_url)
    )
    return {
        ...
        "discovery_url": resolve_discovery_url(args, model, signer_attr=signer_attr),
